(function(){
  "use strict";
  // CGN News archive-safe shell | v8.2.0-Alpha | 2026-05-11T23:10:00Z UTC | Developed by Cook Technology Services
  ...
  function renderHeader(){
    ...
    mount.innerHTML = html`<header class="top-bar">
      ...
      <div class="right-tools"><a id="account-btn" href="${MAIN}/account/">Account</a><div id="datetime"></div><a id="weather" href="${MAIN}/weather/">Weather</a><a class="archive-pill" href="${ARCHIVE}/">Archives</a><a id="news-directory-link" class="news-directory-link" href="${MAIN}/news/" aria-label="CGN News directory"><span class="news-directory-icon" aria-hidden="true"><span class="news-directory-word">NEWS</span><span class="news-directory-paper"><span class="news-directory-line news-directory-line-wide"></span><span class="news-directory-line"></span><span class="news-directory-line"></span><span class="news-directory-box"></span></span></span></a><a id="sports-center-link" class="sports-center-link" href="${MAIN}/sports/" aria-label="CGN Sports Center"><img src="${SPORTS_ICON}" class="sports-center-icon" alt=""><span class="sports-center-text">Sports</span></a>${supportHelpHtml()}${socialHtml()}<a href="${MAIN}/editor/" class="editor-portal-link" aria-label="Open CGN Editor Portal"><span class="editor-portal-pen" aria-hidden="true"></span><span class="editor-portal-text">EDITOR LOGIN</span></a></div>
    </header>`;
